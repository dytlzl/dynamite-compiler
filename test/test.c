...
int test01() { int a=3; int b=4; return a*b; }
int test02() { int a=3; int b=4; return a*a*b==36; }
int test03() { int ice=3; int cream=7; return ice*cream+ice+cream; }
int test04() { int a=3; int c; int b = c = a; return a*b*c; }
int test05() { int a=47; int b=19; return a+b; return a%b; }
int test06() { if (3*6>15) return 5; else return 10; }
int test07() { int x = 5; if (x > 4) x = x+5; return x-3; }
int test08() { int a = 3; while (a*a < 100) a=a+3; return a; }
int test09() { int a = 0; int i; for(i = 0; i < 10; i = i+1) a = a+i; return a; }
int test10() { int a = 0; for (;; a = a+3) if (a >= 10) break; return a; }
int test11() { int a = 0; int i; int j; for (i = 0; i < 10; i = i+1) { j = 0; while (j < 5) { a = a+1; j = j+1; } } return a; }
int test12() { int i; for (i = 0; i < 1;) { break; } return i; }
int test13() { int a = 0; int j = 0; while (1) { if (j>=5) break; a = a+j; j = j+1; } return a; }
int test14() { int a = 0; int i; for (i = 0; i < 10; i = i+1) { int j = 0; while (1) { if (j>=5) break; a = a+1; j = j+1; } } return a; }
int test15() { int x; int *y; y = &x; *y = 3; return x; }
